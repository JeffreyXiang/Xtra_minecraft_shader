...
---------------------------------------------------------------------------------------------
 Idx |   Buffer      |  dtype  | C |     gbuffers     |   composite0-3   |   composite4-    |
---------------------------------------------------------------------------------------------
     |               |         | r |                  |                  |                  |
     |               |         |---|                  |                  |                  |
     |               |         | g |     color_s      |     color_s      |     color_s      |
  0  |   gcolor      | RGBA16F |---|                  |                  |                  |
     |               |         | b |                  |                  |                  |
     |               |         |-------------------------------------------------------------
     |               |         | a |                  |                  |                  |
-------------------------------------------------------------------------------------------
     |               |         | r |     depth_w      |     depth_s      |     depth_s      |
     |               |         |-------------------------------------------------------------
     |               |         | g |   sky_light_w    |     depth_w      |     depth_w      |
  1  |   gdepth      | RGBA32F |-------------------------------------------------------------
     |               |         | b |    block_id_w    |     depth_g      |     depth_g      |
     |               |         |-------------------------------------------------------------
     |               |         | a |                  |                  |                  |
-------------------------------------------------------------------------------------------
     |               |         | r |                  |                  |                  |
     |               |         |---|                  |                  |                  |
     |               |         | g |     normal_s     |     normal_s     |     normal_s     |
  2  |   gnormal     | RGBA16F |---|                  |                  |                  |
     |               |         | b |                  |                  |                  |
     |               |         |-------------------------------------------------------------
     |               |         | a |    block_id_s    |    block_id_s    |    block_id_s    |
---------------------------------------------------------------------------------------------
     |               |         | r |                  |                  |                  |
     |               |         |---|                  |                  |                  |
...
---------------------------------------------------------------------------------------------
     |               |         | r |                  |                  |                  |
     |               |         |----                  |                  |                  |
     |               |         | g |     normal_g     |     normal_g     |     normal_g     |
  5  |   gaux2       | RGBA16F |----                  |                  |                  |
     |               |         | b |                  |                  |                  |
     |               |         |-------------------------------------------------------------
     |               |         | a |                  |                  |                  |
---------------------------------------------------------------------------------------------
     |               |         | r |  block_light_s   |  block_light_s   |  block_light_s   |
     |               |         |---|------------------|--------------------------------------
     |               |         | g |   sky_light_s    |   sky_light_s    |   sky_light_s    |
  6  |   gaux3       | RGBA16F |-------------------------------------------------------------
     |               |         | b |                  |   sky_light_w    |   sky_light_w    |
     |               |         |-------------------------------------------------------------
     |               |         | a |                  |   sky_light_g    |   sky_light_g    |
---------------------------------------------------------------------------------------------
     |               |         | r |     depth_g      |      dist_s      |      dist_s      |
     |               |         |-------------------------------------------------------------
     |               |         | g |   sky_light_g    |      dist_w      |      dist_w      |
  7  |   gaux4       | RGBA32F |-------------------------------------------------------------
...
---------------------------------------------------------------------------------------------
  ...
  11 |   colortex11  | RGBA16F |---|                  |                  |                  |
     |               |         | b |                  |                  |                  |
     |               |         |-------------------------------------------------------------
     |               |         | a |   dist_s_prev    |   dist_s_prev    |   dist_s_prev    |
---------------------------------------------------------------------------------------------
     |               |         | r |                  |                  |                  |
